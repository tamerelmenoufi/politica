...
<div class="card shadow mb-4">
    <div class="card-header py-3 d-flex flex-md-row flex-column align-items-center justify-content-md-between">
        ...
        <div class="d-block">
            <?php
            if(in_array('Psicologia - Cadastrar', $ConfPermissoes)){
            ?>
            <button
                    type="button"
            ...
            if(in_array('Psicologia - Editar', $ConfPermissoes)){
            ?>
            <button
                    type="button"
            ...
            if(in_array('Psicologia - Logs', $ConfPermissoes)){
                ?>
                    <button
                            type="button"
            ...
            if(in_array('Psicologia - Excluir', $ConfPermissoes)){
            ?>
            <button
                    type="button"
