...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (mysql_query($query)) {
        ...
        sis_logs($codigo, $query, 'servicos', 'serviço');
    ...
    <div class="card-body">
        <form id="form-servicos">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="data_pedido">Data do Pedido <i class="text-danger">*</i></label>
                        <input
                                type="datetime-local"
                                class="form-control"
                                id="data_pedido"
                                name="data_pedido"
                                value="<?= $codigo ? strftime('%Y-%m-%dT%H:%M:%S', strtotime($d->data_pedido)) : ''; ?>"
                                required
                        >
