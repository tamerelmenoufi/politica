<?php
include_once "config_municipios.php";

if ($_SERVER['REQUEST_METHOD'] === 'POST' and $_POST['acao'] === 'excluir') {
    $codigo = $_POST['codigo'];

    if (exclusao('municipios', $codigo)) {
...
$query = "SELECT * FROM municipios WHERE deletado = '0'";
                    ...
                    <tr id="linha-<?= $d->codigo; ?>">
                        ...
                        <td>
                            <button
                                    ...
                                    url="<?= $urlMunicipios ?>/visualizar.php?codigo=<?= $d->codigo ?>"
                            >
