...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb shadow bg-gray-custom">
        ...
        <li class="breadcrumb-item active" aria-current="page">Categorias de Serviço</li>
    </ol>
</nav>
...
<div class="card shadow mb-4">
    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
        ...
        <?php
        if(in_array('Categorias de Serviço - Cadastrar', $ConfPermissoes)){
        ?>
                ...
                <?php while ($d = mysql_fetch_object($result)): ?>
                    <tr id="linha-<?= $d->codigo; ?>">
                        ...
                        <td>
                            ...
                            <?php
                            if(in_array('Categorias de Serviço - Editar', $ConfPermissoes)){
                            ?>
                            <button
                                    class="btn btn-sm btn-link"
                            ...
                            if(in_array('Categorias de Serviço - Excluir', $ConfPermissoes)){
                            ?>
