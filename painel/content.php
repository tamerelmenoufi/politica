...
$queryAcaoSocial = "(SELECT COUNT(*) FROM acao_social) AS acao_social";

$queryCount = "SELECT {$queryBeneficiado}{$queryServicos}{$queryAssessores}{$queryAcaoSocial}";
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $dadosCount->acao_social; ?></div>
                    </div>
                    <div class="col-auto">
